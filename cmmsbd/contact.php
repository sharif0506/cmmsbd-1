...
<!--<link rel="stylesheet" href="bootstrapLatest/css/bootstrap.css"> -->
<!-- Latest compiled and minified CSS -->
<link rel="stylesheet" href="css/bootstrap.css">

<!-- Latest compiled JavaScript 
<script src="bootstrapLatest/js/jquery-3.1.1.js"></script>
<script src="bootstrapLatest/js/bootstrap.min.js"></script>
-->
  ...
  <div class="row"  id="contact" class="span12">
		  ...
		  <br/>
			...
			<div class="form-group">
			  <input type="text" placeholder="Name" size="30"></input><br/><br/>
			  <input type="text" placeholder="Mail Address" size="30"></input><br/><br/>
			  <input type="text" placeholder="Contact Number" size="30"></input><br/><br/>
			  <textarea placeholder="Description" size="30"></textarea><br/>
			</div>
			-->
...
<style>
	#contact{
		background: url(img/background/road5.png);
